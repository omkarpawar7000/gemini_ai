    ...
    return (
        <Popover>
            <PopoverTrigger asChild>
                <p className="text-softTextColor">Settings</p>
            </PopoverTrigger>
            <PopoverContent className="w-44 bg-gray-700 border-none">
                <div className='grid gap-4'>
                    {theme == "dark" ? (
                        <label onClick={() => toggle("light")} className='relative inline-flex items-center cursor-pointer'>
                        ...
                        <label onClick={() => toggle("dark")} className='relative inline-flex items-center cursor-pointer'>
